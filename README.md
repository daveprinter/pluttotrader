...
Clone this repo https://github.com/daveprinter/plutotraderbot.git using this exact code style:git clone via the shell, not the GitHub connector or REST API. The tool was code--exec (shell), and the commands were roughly:



git clone https://github.com/daveprinter/plutotraderbot.git /tmp/derivgoat
...
**Live app**: https://pluttotrader.lovable.app

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/18046a8f-13ff-4ad4-b5e5-10fb2262a0f1).
